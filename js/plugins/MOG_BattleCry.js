...
　　var Moghunter = Moghunter || {}; 	
	...
	// ACTOR - BATTLE START
	// -----------------------------------------------------------------------
	Moghunter.v_actor_start[1] = ["P1_Voice_01","P1_Voice_08","P1_Victory_04"];//
	Moghunter.v_actor_start[2] = ["P2_Voice_02","P2_Voice_13"];//
	Moghunter.v_actor_start[3] = ["P3_Voice_03","P3_Voice_14"];//
	Moghunter.v_actor_start[4] = ["P4_Voice_11","P4_Voice_12"];//
	// -----------------------------------------------------------------------
	// ACTOR - BATTLE TURN
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_turn[1] = ["P1_Voice_01","P1_Voice_12"];//
	Moghunter.v_actor_turn[2] = ["P2_Start_01","P2_Voice_02","P2_Voice_04"];//
	Moghunter.v_actor_turn[3] = ["P3_Voice_16","P3_Voice_18","P3_Voice_06"];//
	Moghunter.v_actor_turn[4] = ["P4_Voice_14","P4_Voice_10"];//
	// -----------------------------------------------------------------------
	// ACTOR - DEFAULT ACTION (Skill/ITEM)
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_default_action[1] = ["P1_Voice_02","P1_Voice_05","P1_Voice_13"];//
	Moghunter.v_actor_default_action[2] = ["P2_Attack_02","P2_Voice_05"];//
	Moghunter.v_actor_default_action[3] = ["P3_Voice_03","P3_Voice_16"];//
	Moghunter.v_actor_default_action[4] = ["P4_Voice_01","P4_Voice_03"];//
	// -----------------------------------------------------------------------
	// ACTOR - SKILL
	// -----------------------------------------------------------------------	
    ...
    Moghunter.v_actor_skill[1] = {
		 1:["P1_Attack_01","P1_Attack_02","P1_Attack_03","P1_Attack_04",
		    "P1_Attack_05","P1_Attack_06"], // Attack
		 9:["P1_Action_04","P1_Action_05","P1_Action_06"], // Fire
	    10:["P1_Action_07","P1_Action_08","P1_Action_09"] // Spark
	};
	Moghunter.v_actor_skill[2] = {
		 1:["P2_Attack_01","P2_Attack_02","P2_Attack_03","P2_Attack_04"], // Attack
		 9:["P2_Attack_01","P2_Attack_02","P2_Attack_03"], // Fire
		14:["P2_Voice_13"], //suzumu
		15:["P2_Start_01"] //suzumu
    	};
	Moghunter.v_actor_skill[3] = {
		 1:["P3_Voice_08","P3_Voice_09","P3_Voice_10","P3_Voice_07"] //Attack
	};
	Moghunter.v_actor_skill[4] = {
		 1:["P4_Attack_01","P4_Voice_02"] //Attack
	};
	// -----------------------------------------------------------------------
	// ACTOR - ITEM
	// -----------------------------------------------------------------------	
    Moghunter.v_actor_item[1] = {
		1:["P1_Voice_02","P1_Voice_05","P1_Voice_13"],  // Potion
	}; 
	Moghunter.v_actor_item[2] = {1:["P2_Voice_05"]};//
	Moghunter.v_actor_item[3] = {1:["P3_Voice_03"]};//
	Moghunter.v_actor_item[4] = {1:["P4_Voice_01","P4_Voice_03"]};//
	// -----------------------------------------------------------------------
	// ACTOR - DAMAGE
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_damage[1] = ["P1_Damage_01","P1_Damage_02","P1_Damage_03","P1_Damage_04"];//
	Moghunter.v_actor_damage[2] = ["P2_Damage_01"];//
	Moghunter.v_actor_damage[3] = ["P3_Voice_11"]; //
	Moghunter.v_actor_damage[4] = ["P4_Damage_01"];//
	// -----------------------------------------------------------------------
	// ACTOR - EVADED  &   MISS
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_evaded[1] = ["P1_Voice_16"];//
	Moghunter.v_actor_evaded[2] = ["P2_Voice_11"];//
	Moghunter.v_actor_evaded[3] = ["P3_Voice_08"];//
	Moghunter.v_actor_evaded[4] = ["P4_Voice_01"];//
	// -----------------------------------------------------------------------
	// ACTOR - COUNTER
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_counter[1] = ["P1_Attack_01","P1_Attack_02","P1_Attack_03"];//
	Moghunter.v_actor_counter[2] = ["P2_Attack_03"];//
	Moghunter.v_actor_counter[3] = ["P3_Voice_08"];//
	Moghunter.v_actor_counter[4] = ["P4_Voice_04"];//	
	// -----------------------------------------------------------------------
	// ACTOR - REFLECTION
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_reflection[1] = ["P1_Voice_17"];//
	Moghunter.v_actor_reflection[2] = ["P2_Attack_04"];//
	Moghunter.v_actor_reflection[3] = ["P3_Voice_10"];//
	Moghunter.v_actor_reflection[4] = ["P4_Voice_09"];//		
	// -----------------------------------------------------------------------
	// ACTOR - RECOVER
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_recover[1] = ["P1_Recover_01","P1_Voice_10"];//
	Moghunter.v_actor_recover[2] = ["P2_Voice_11"]; //
	Moghunter.v_actor_recover[3] = ["P3_Voice_16","P3_Voice_19"];//
	Moghunter.v_actor_recover[4] = ["P4_Voice_09"];//
	// -----------------------------------------------------------------------
	// ACTOR - DEAD
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_dead[1] = ["P1_Dead_01"];//
	Moghunter.v_actor_dead[2] = ["P2_Dead_01","P2_Dead_02","P2_Dead_03"];//
	Moghunter.v_actor_dead[3] = ["P3_Voice_15"];//
	Moghunter.v_actor_dead[4] = ["P4_Dead_01","P4_Voice_11"];//
	// -----------------------------------------------------------------------
	// ACTOR - ESCAPE
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_escape[1] = ["P1_Voice_14"];//
	Moghunter.v_actor_escape[2] = ["P2_Escape_01"];//
	Moghunter.v_actor_escape[3] = ["P3_Voice_04","P3_Voice_05"];//
	Moghunter.v_actor_escape[4] = ["P4_Voice_16"];//
	// -----------------------------------------------------------------------
	// ACTOR - VICTORY
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_victory[1] = ["P1_Victory_01","P1_Victory_02","P1_Victory_03","P1_Victory_04"];//
	Moghunter.v_actor_victory[2] = ["P2_Victory_01","P2_Victory_02","P2_Victory_03","P2_Victory_04"];//
	Moghunter.v_actor_victory[3] = ["P3_Voice_12","P3_Voice_13","P3_Voice_14","P3_Voice_20"];//
	Moghunter.v_actor_victory[4] = ["P4_Voice_08","P4_Voice_10"];//
	// -----------------------------------------------------------------------
	// ACTOR - LEVEL UP
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_levelup[1] = ["P1_Victory_02"];//
	Moghunter.v_actor_levelup[2] = ["P2_Victory_03"];//
	Moghunter.v_actor_levelup[3] = ["P3_Voice_20"];//
	Moghunter.v_actor_levelup[4] = ["P4_Voice_08"];//
